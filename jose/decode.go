...
func ExpectSignature(alg string, jwks *JSONWebKeySet) DecoderOpt {
	return func(n *Decoder) {
		if IsNoneOrEmpty(alg) || jwks == nil {
			return
		}
...
func ExpectEncryption(alg string, jwks *JSONWebKeySet) DecoderOpt {
	return func(n *Decoder) {
		if IsNoneOrEmpty(alg) || jwks == nil {
			return
		}
...
type Decoder struct {
	token              string
	verificationAlg    string
	verificationKeySet *JSONWebKeySet
	decryptionAlg      string
...
func (n *Decoder) expectSignature() bool {
	return !IsNoneOrEmpty(n.verificationAlg) && n.verificationKeySet != nil
}

func (n *Decoder) expectEncryption() bool {
	return !IsNoneOrEmpty(n.decryptionAlg) && n.decryptionKeySet != nil
}
